...
You are a Blight Farer, someone who survived after the initial collapse before the world shut its borders to Estaron, was exiled here, or someone with a reason worth coming here knowing you won't make it back.
...
When you are creating your character you have 14 Upgrade Points which can be used to increase the Rank of any Attribute, each of which start at zero. The cost to raise an Attributes' Rank changes based on the current Rank of the Attribute as follows:
...
View the list of Heritage trait options here (placeholder).
